          ...
          {data.map((entry, i) => (
            ...
            >
              <td className="py-3 px-3 text-center">
                <span className={`inline-flex items-center justify-center w-6 h-6 rounded text-xs font-bold ${posClass(i)}`}>
                  {i + 1}
                </span>
              </td>
              <td className="py-3 px-3 text-left">
                <span className="mr-2">{entry.team.emoji}</span>
                <span className="font-semibold text-sm">{entry.team.name}</span>
