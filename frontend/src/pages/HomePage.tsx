...
import { matchesApi, newsApi, playersApi, announcementsApi } from '../services/api'
...
export default function HomePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setNews((newsData.results || []).filter((n) => n.tag !== 'announcement').slice(0, 3))
    ...
    <div>
      ...
      <div className="relative bg-pitch-light overflow-hidden py-12">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <cite className="text-gray-400 text-sm not-italic font-medium">— Hebrews 12:1</cite>
                ...
                {scorers.map((p, i) => (
                  <Card key={p.id} hover className="p-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="w-9 h-9 rounded-full overflow-hidden flex items-center justify-center text-sm font-bold flex-shrink-0 bg-pitch">
                        {p.photo_url ? (
